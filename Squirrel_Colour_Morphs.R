...
{ #run this line to read all data files
  ...
  df_2019_completed <- read_csv("Data/sq_RGB_2019_1_15000.csv")
...
df_2019_15001_15250 = df_2019_noerrors %>%
  #slice() %>%
  rowwise() %>%
...
df_2019_15001_15250_col <- df_2019_15001_15250 %>%
...
df_2019_new <- df_2019_completed %>%
  rbind(df_2019_15001_15250_col) #insert name of newly created df here
...
write_csv(df_2019_new, "Data/sq_RGB_2019_1_15250.csv")
