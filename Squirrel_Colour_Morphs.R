...
df_2019_7751_8000 = df_2019_noerrors %>%
  #slice() %>%
  rowwise() %>%
...
df_2019_7751_8000_col <- df_2019_7751_8000 %>%
...
df_2019_new <- df_2019_completed %>%
  rbind(df_2019_7751_8000_col) #insert name of newly created df here
...
write_csv(df_2019_new, "Data/sq_RGB_2019_1_8000.csv")
